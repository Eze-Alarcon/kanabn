  ...
  return (
    <>
      <section className='absolute w-full h-full bg-black bg-opacity-60 flex items-center justify-center'>
        <div className='w-[343px] h-[659px] md:w-[480px] md:h-[675px] rounded-lg bg-kwhite'>
          <div className='pl-6 pr-6'>
            ...
            <form action=''>
              ...
              <Button style='secondary' wi={`${'295'}`} mdwi={`${'full'}`}>+add new task</Button>
              ...
              <Button style='primarysm' wi={`${'295'}`} mdwi={`${'full'}`}>create task</Button>
            </form>
          </div>
        </div>
      </section>
